...
RUN /opt/android-sdk-linux/cmdline-tools/tools/bin/sdkmanager "platforms;android-21"
RUN /opt/android-sdk-linux/cmdline-tools/tools/bin/sdkmanager "system-images;android-21;google_apis;x86_64"
